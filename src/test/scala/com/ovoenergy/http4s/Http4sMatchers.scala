...
/**
  ...
  * TODO: this should probably be split out into its own project or added as a PR for the http4s project
  * to include in addition to the specs2 code
  */
